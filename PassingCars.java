...
public class PassingCars {
    ...
    private boolean carTravelingEast(int car) { return (car == 0);}

    private boolean limitOfPassingCar(int result) { return (result > 1000000000);}
    ...
    public int solution(int[] A) {
        ...
        for (int car : A) {
            ...
            if (carTravelingEast(car)) numberOfCarsTravelingEast += 1;
            else countPassingCars += numberOfCarsTravelingEast;

            if(limitOfPassingCar(countPassingCars)) return -1;
        }
